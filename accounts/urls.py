...
urlpatterns = [
    ...
    path('comments_list/liked/', views.LikedCommentListView.as_view(), name='comments_liked'),
    path('comments_list/saved/', views.SavedCommentListView.as_view(), name='comments_saved'),
